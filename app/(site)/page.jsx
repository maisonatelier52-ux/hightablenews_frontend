...
export default async function HomePage() {
  ...
  // None of the homepage's blocks render an article's full body — only
  // title/excerpt/image/author — but each of the 60 fetched articles still
  // carried its full `content` (rich block array) + `contentHtml` from the
  // backend. That's what was bloating the page and tanking the Text/HTML
  // ratio. Strip both before sending to the client.
